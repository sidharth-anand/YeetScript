...
# Commands
<!-- commands -->
* [`YeetScriptCompiler help [COMMAND]`](#yeetscriptcompiler-help-command)
...
_See code: [dist/commands/parse.ts](https://github.com/sidharth-anand/yeetscript-compiler/blob/v0.0.0/dist/commands/parse.ts)_
<!-- commandsstop -->
